...
namespace BACKPACKapp
{
    internal class AddNewGroupClass 
    {
        ...
        private static int[,] GroupsLocationsCoordinatesForButtons = { {476,976,1476,476,976,1476},{280,280,280,530,530,530} };
        private static int[,] GroupsLocationsCoordinatesForLabels = { {45,545,1045,45,545,1045},{280,280,280,530,530,530} };
        private static int[,] GroupsLocationsCoordinatesForWeight = { {245,745,1245,245,745,1245},{280,280,280,530,530,530} };
        private bool[] LocationOfPositionStatus = {true, true, true, true, true, true};
        private int j = 0;
        public void AddNewGroup(string name,Label[] labels,Label[] weights,bool[] ID,DataGridView[] DataGridViews,Button[] Buttons, int CurrentGroupsID, out DataGridView dataGridViewReturn,out Button button,out bool[] locationOfPositionStatusReturn,out bool[] IDReturn,out int l)
        {
            l = 0;
            for (int CurrentLocationOfPosition = 0; CurrentLocationOfPosition < 6; CurrentLocationOfPosition++)
            {
                ...
                for(j=0;j<6;j++)
                    ...
                    //
                    weights[j].Location=new Point(GroupsLocationsCoordinatesForWeight[0,CurrentLocationOfPosition],GroupsLocationsCoordinatesForWeight[1,CurrentLocationOfPosition] );
